...
public class TestInicialActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_inicial);
       ...
       // Toast.makeText(getApplicationContext(),"INCORRECTAS "+incorrectas,Toast.LENGTH_LONG).show();
        ...
        if (incorrectas>=(respuestaEstudiante.size()/2)+1){
            ...
            //iniciarDabaseReference2(UtilsBottomNavigation.NODO_USUARIOS,user.getUid());
             ...
             if(unidadP.equals(UtilsBottomNavigation.NODO_UNIDAD_UNO)) {
                 datos.put(unidadP, true);
                 int dato= UtilsBottomNavigation.actualizarAvance(unidadP);

                 datos.put(UtilsBottomNavigation.NODO_NIVEL,dato);

             }else{
                 datos.put(unidadP, false);
                 int dato= UtilsBottomNavigation.actualizarAvance(unidadP);
            ...
            finish();
             ...
             if (unidadP.equals(UtilsBottomNavigation.NODO_UNIDAD_TRES)){
                 datos.put(UtilsBottomNavigation.NODO_UNIDAD_CUATRO, true);
        ...
        datos.put(UtilsBottomNavigation.NODO_TEST_INICIAL,true);
